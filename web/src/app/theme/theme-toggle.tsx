...
const PREFERENCE_ICON: Record<ThemePreference, typeof Sun> = { light: Sun, dark: Moon, system: Monitor, midnight: MoonStar }
const PREFERENCE_LABEL: Record<ThemePreference, string> = { light: 'Light', dark: 'Dark', system: 'System', midnight: 'Midnight' }
const OPTIONS: ThemePreference[] = ['light', 'dark', 'midnight', 'system']

/** Top-bar appearance control — Sun/Moon/Monitor icon button opening a Light/Dark/Midnight/System menu. Shares state with the Settings page via useTheme(). */
