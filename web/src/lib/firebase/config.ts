 ...
 */
// Next inlines process.env.NEXT_PUBLIC_* only where referenced literally, so we map each VITE_* key
// the rest of this file expects to its NEXT_PUBLIC_* equivalent here. Keeps the URL-resolution logic
// below unchanged from the Vite app. See docs/NEXTJS_MIGRATION.md appendix for the full map.
const env: Record<string, string | undefined> = {
  ...
  VITE_FIREBASE_FUNCTIONS_REGION: process.env.NEXT_PUBLIC_FIREBASE_FUNCTIONS_REGION,
  VITE_USE_EMULATORS: process.env.NEXT_PUBLIC_USE_EMULATORS,
  VITE_FIREBASE_EXTRACT_REVIEW_URL: process.env.NEXT_PUBLIC_FIREBASE_EXTRACT_REVIEW_URL,
  VITE_FIREBASE_TRANSCRIBE_URL: process.env.NEXT_PUBLIC_FIREBASE_TRANSCRIBE_URL,
  VITE_FIREBASE_TRANSCRIBE_VOICE_URL: process.env.NEXT_PUBLIC_FIREBASE_TRANSCRIBE_VOICE_URL,
  VITE_FIREBASE_RECALL_AI_URL: process.env.NEXT_PUBLIC_FIREBASE_RECALL_AI_URL,
  VITE_FIREBASE_BENCHMARK_URL: process.env.NEXT_PUBLIC_FIREBASE_BENCHMARK_URL,
  VITE_RECALL_DEMO: process.env.NEXT_PUBLIC_RECALL_DEMO,
}
 ...
 */
export const useEmulators = (process.env.NODE_ENV !== 'production') && env.VITE_USE_EMULATORS === 'true'
