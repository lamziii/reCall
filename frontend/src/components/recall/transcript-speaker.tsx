...
export function TranscriptSpeaker({
  ...
  return (
    <div className={cn('flex gap-3 rounded-lg p-2 transition-fast', active && 'bg-surface-selected', className)}>
      <Avatar name={name} src={avatarSrc} size="sm" className="mt-0.5" />
