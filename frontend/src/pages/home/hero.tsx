...
export function Hero() {
  return (
    <section id="top" className="relative pt-36 pb-28 sm:pt-48 lg:pb-32">
      <div
        aria-hidden
        ...
        <div className="flex flex-col items-start">
          ...
          <Reveal delay={0.16}>
            <BodyLarge className="max-w-[480px] text-muted-foreground">
              Recall turns your meetings into decisions, tasks, and knowledge your team can search forever.
            </BodyLarge>
          </Reveal>
        </div>
